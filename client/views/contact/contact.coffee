Template.kontakt.invokeAfterLoad = ->
  Meteor.defer () ->
    mapOptions = {
    ...
    marker = new google.maps.Marker( {map: map, position: new google.maps.LatLng(52.53200, 13.42768), icon: '/img/kontakt/maps-marker.png'} )
